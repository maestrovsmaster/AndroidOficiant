...
public class TimePickerActivity extends Activity {
    ...
    /**
     * Adds changing listener for maestrovs.androidofficiant.spinnerwheel that updates the maestrovs.androidofficiant.spinnerwheel label
     * @param wheel the maestrovs.androidofficiant.spinnerwheel
     * @param label the maestrovs.androidofficiant.spinnerwheel label
     */
    private void addChangingListener(final AbstractWheel wheel, final String label) {
        wheel.addChangingListener(new OnWheelChangedListener() {
            public void onChanged(AbstractWheel wheel, int oldValue, int newValue) {
                //maestrovs.androidofficiant.spinnerwheel.setLabel(newValue != 1 ? label + "s" : label);
            }
        });
    }
}
