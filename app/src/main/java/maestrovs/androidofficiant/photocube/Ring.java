 ...
 */
public class Ring implements Telo{
    ...
    public Ring(Context context,  float radius,  int koef, int textureResId) {
    ...
    public void calculateVertexes(double fi,double teta) {
        ...
        X=0;Y=0;Z=-20;
        Log.d("my", "ring X = " + X + " Y = " + Y + "  Z = " + Z);
        Log.d("my","radius = "+radius);
       ...
       // for (int c = 0; c < numF/2; c++)
            ...
            for (int d = 0; d < numF; d++) {
                ...
                float x3 = (float) (X + (radius+radius/4) *Math.sin(Math.toRadians(teta)) *Math.sin(Math.toRadians(fi)));
                float y3 = (float) (Y - (radius+radius/4) *Math.cos(Math.toRadians(teta)));
                float z3 = (float) (Z + (radius+radius/4) *Math.sin(Math.toRadians(teta)) *Math.cos(Math.toRadians(fi)));

                float x4 = (float) (X + (radius+radius/4) *Math.sin(Math.toRadians(teta)) *Math.sin(Math.toRadians(fi2)));
                float y4 = (float) (Y - (radius+radius/4) *Math.cos(Math.toRadians(teta)));
                float z4 = (float) (Z + (radius+radius/4) *Math.sin(Math.toRadians(teta)) *Math.cos(Math.toRadians(fi2)));

                //if(d==0)
                    Log.d("my",x1+" "+y1+" "+z1+" "+" ---- "+x2+" "+y2+" "+z2+" "+" ---- "+x3+" "+y3+" "+z3+" "+" ---- "+x4+" "+y4+" "+z4+" "+" ---- ");

                //Log.d("my", "X = " + X + " Y = " + Y + "  Z = " + Z);
