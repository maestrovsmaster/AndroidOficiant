...
/**
 * Scroller class handles scrolling events and updates the maestrovs.androidofficiant.spinnerwheel
 */
public abstract class WheelScroller {
    ...
    public WheelScroller(Context context, ScrollingListener listener) {
        gestureDetector = new GestureDetector(context, new SimpleOnGestureListener() {
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                //  when user touch and move the maestrovs.androidofficiant.spinnerwheel
                return true;
            }
    ...
    /**
     * Justifies maestrovs.androidofficiant.spinnerwheel
     */
