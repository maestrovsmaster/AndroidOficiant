...
/**
 * Recycle stored maestrovs.androidofficiant.spinnerwheel items to reuse.
 */
public class WheelRecycler {
    ...
    /**
     * Constructor
     * @param wheel the maestrovs.androidofficiant.spinnerwheel view
     */
     ...
     * @param range the range of current maestrovs.androidofficiant.spinnerwheel items
