/*
 * android-maestrovs.androidofficiant.spinnerwheel
...
package maestrovs.androidofficiant.spinnerwheel;
...
import maestrovs.androidofficiant.spinnerwheel.adapters.WheelViewAdapter;


/**
 * Abstract spinner maestrovs.androidofficiant.spinnerwheel view.
...
public abstract class AbstractWheel extends View {
    ...
    /**
     * Scroll the maestrovs.androidofficiant.spinnerwheel
     *
    ...
    public void scroll(int itemsToScroll, int time) {
        ...
        onScrollTouched(); // we have to emulate touch when scrolling maestrovs.androidofficiant.spinnerwheel programmatically to light up stuff
    ...
    /**
     * Scrolls the maestrovs.androidofficiant.spinnerwheel
     *
    ...
    /**
     * Returns base dimension of the maestrovs.androidofficiant.spinnerwheel — width for horizontal maestrovs.androidofficiant.spinnerwheel, height for vertical
     *
     * @return width or height of the maestrovs.androidofficiant.spinnerwheel
     */
    abstract protected int getBaseDimension();

    /**
     * Returns base dimension of base item — width for horizontal maestrovs.androidofficiant.spinnerwheel, height for vertical
     *
    ...
    /**
     * Processes MotionEvent and returns relevant position — x for horizontal maestrovs.androidofficiant.spinnerwheel, y for vertical
     *
     ...
     * Actual amount of visible items depends on maestrovs.androidofficiant.spinnerwheel layout parameters.
    ...
    /**
     * Tests if maestrovs.androidofficiant.spinnerwheel is cyclic. That means before the 1st item there is shown the last one
     *
     * @return true if maestrovs.androidofficiant.spinnerwheel is cyclic
     */
    ...
    /**
     * Set maestrovs.androidofficiant.spinnerwheel cyclic flag
     *
    ...
    /**
     * Adds maestrovs.androidofficiant.spinnerwheel changing listener
     *
    ...
    /**
     * Removes maestrovs.androidofficiant.spinnerwheel changing listener
     *
     * @param listener the listener
     */
     ...
     *
     * @param oldValue the old maestrovs.androidofficiant.spinnerwheel value
     * @param newValue the new maestrovs.androidofficiant.spinnerwheel value
     */
    ...
    /**
     * Adds maestrovs.androidofficiant.spinnerwheel scrolling listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Removes maestrovs.androidofficiant.spinnerwheel scrolling listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Adds maestrovs.androidofficiant.spinnerwheel clicking listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Removes maestrovs.androidofficiant.spinnerwheel clicking listener
     *
     * @param listener the listener
     */
    ...
    /**
     * Rebuilds maestrovs.androidofficiant.spinnerwheel items if necessary. Caches all unused items.
     *
    ...
    /**
     * Calculates range for maestrovs.androidofficiant.spinnerwheel items
     *
     ...
     *
     * @param index the item index
     * @return true if item index is not out of bounds or the maestrovs.androidofficiant.spinnerwheel is cyclic
     */
