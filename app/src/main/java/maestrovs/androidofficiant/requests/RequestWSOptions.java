...
public class RequestWSOptions {
   ...
   // ArrayList<Inventory> jsonObject = new ArrayList<>();
     ...
     * @return
     */
    public JSONObject getWSOptions ()
    {
    ...
    public void request() {
            ...
            String  returnString="";
    		 ...
    		 try{
                 ...
                 URL url = new URL(MainApplication.mainURL+"/WSOptionsServlet");
                 ...
                 Log.d("my","===wsoptions=="+jsonObj.toString());
